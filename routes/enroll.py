...
from schemas.enrollment import CreateEnrollment, UpdateCompleted
...
@course_enroll.post("/enrollments/course", status_code=201)
...
@course_enroll.get("/users/{user_id}/enrollment", status_code=200)
...
@course_enroll.patch("/enrollments/{enrollment_id}/completed", status_code=204)
...
@course_enroll.get("/enrollments", status_code=200)
